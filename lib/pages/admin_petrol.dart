...
class PetrolAdminDashboard extends StatefulWidget {
  const PetrolAdminDashboard({super.key});

  @override
  State<PetrolAdminDashboard> createState() => _PetrolAdminDashboardState();
}

class _PetrolAdminDashboardState extends State<PetrolAdminDashboard> {
  ...
  String _selectedCollection = 'petrol_pumbs';
  ...
  Future<String?> _uploadImage() async {
    ...
    try {
      ...
      final String fileName = 'petrol_pumbs/${DateTime.now().millisecondsSinceEpoch}_${_nameController.text.trim().replaceAll(' ', '_').toLowerCase()}.jpg';
  ...
  Future<void> _addPetrolPump() async {
    ...
    try {
      ...
      // Create petrol pump object
      final petrolPump = Petrol(
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Error adding petrol pump: ${e.toString()}'),
            backgroundColor: Colors.red,
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Fill in the details below to add a new petrol pump to the database.',
                      style: GoogleFonts.outfit(
                        fontSize: 14,
                ...
                child: DropdownButton<String>(
                  ...
                  items: _collections.map((String collection) {
                    return DropdownMenuItem<String>(
                      value: collection,
                      child: Text(
                        collection.replaceAll('petrol_pumbs_', '').replaceAll('petrol_pumbs', 'Default').toUpperCase(),
              ...
              // Petrol Pump Name Field (Mandatory)
              _buildFormField(
                label: 'Petrol Pump Name *',
                controller: _nameController,
                validator: (value) {
                  if (value == null || value.trim().isEmpty) {
                    return 'Petrol pump name is required';
                  }
                  return null;
                },
              ...
              _buildFormField(
                ...
                hintText: 'Enter petrol pump location',
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _isLoading ? null : _addPetrolPump,

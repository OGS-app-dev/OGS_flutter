...
class _RestaurantAdminDashboardState extends State<RestaurantAdminDashboard> {
  ...
  String _selectedCollection = 'res_kattangal';
  ...
  Future<String?> _uploadImage() async {
    ...
    try {
      ...
      final String fileName = 'restaurants/${DateTime.now().millisecondsSinceEpoch}_${_nameController.text.trim().replaceAll(' ', '_').toLowerCase()}.jpg';
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Fill in the details below to add a new restaurant to the database.',
                      style: GoogleFonts.outfit(
                        fontSize: 14,
                ...
                child: DropdownButton<String>(
                  ...
                  items: _collections.map((String collection) {
                    return DropdownMenuItem<String>(
                      value: collection,
                      child: Text(
                        collection.replaceAll('res_', '').toUpperCase(),
              ...
              // Restaurant Name Field (Mandatory)
              _buildFormField(
